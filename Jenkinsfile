pipeline {
	agent any
    environment {
        cred_davitacorp_vcenter = credentials('02ce81e7-6ab7-4c43-bc82-6104fe08b769')
        cred_davitacorp_adjoin = credentials('5d000f2e-6b25-42cf-8b6c-a25d03ea1827')
        cred_dvakeyqa_vcenter = credentials('02ce81e7-6ab7-4c43-bc82-6104fe08b769')
